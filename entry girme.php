...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if ( empty(test_input($_POST["icerik"])) ){
           ...
           $sql = "INSERT INTO entry (sahip, icerik, baslik)
            VALUES ('" . $k_id . "','". $icerik . "', '" . $baslik_id . "')";

            if ($conn->query($sql) === TRUE) {
                echo "<h3>Entry başarı ile oluşturuldu, yönlendiriliyorunuz...</h3>";
				header("Refresh:1; url=http://theamazingpets.com/index.php");
...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">Konular</a>
      </li>
   ...
   <?php include 'basliklar.php';?>
    ...
    <div class="sagdiv">
        ...
        <h1><?php echo $baslik_adi;?> Konusuna Entry Gir</h1> <br>
        
		 <form method="post" action="entry girme.php?baslik=<?php $baslik_id = test_input($_GET['baslik']);
echo $baslik_id; ?>" >
  <div class="form-group">
    <label for="exampleFormControlTextarea1"> Entry:</label>
     <textarea rows="7" name="icerik" class="form-control" id="exampleFormControlTextarea1" >
</textarea><br>
      <input type="submit" name="buton" class="btn btn-secondary btn-lg btn-block" value="Gir" >
  </div>
            <br>
</form>
