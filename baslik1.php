...
http://localhost/baslik1.php?baslik=96&sayfa=1

if(!isset($_SESSION['k_id'])){
		 header("Location:http://theamazingpets.com/misafir_baslik.php?baslik=".$baslik_id."&sayfa=".$sayfa); 
...
<body>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item"  href="baslik_silme.php?baslik_id=<?php echo $baslik_id_int; ?>">Konuyu ve Bu Konuya Yazılan Tüm Entry'leri Sil (Mod)</a>
  </div>
        </a>
        <br> 
