...
if(!isset($_SESSION['k_id'])){
    ...
    $_SESSION = array();
    session_destroy();
    header("http://theamazingpets.com/giris_yap.php");
    ob_end_flush();
...
<div style=" margin: 0px; width: 285px; height: 800px; overflow-y: scroll; overflow-x: hidden;">
  ...
  <li class="list-group-item d-flex justify-content-between align-items-center">
   <a class="badge badge-light" href="index.html"> forumfutbol Başlık 1</a> 
    <span class="badge badge-dark badge-tabl">14</span>
  </li>
  <li class="list-group-item d-flex justify-content-between align-items-center">
      <a class="badge badge-light" href="index.html"> forumfutbol Başlık 2</a> 
    <span class="badge badge-dark badge-tab">2</span>
  </li>
  <li class="list-group-item d-flex justify-content-between align-items-center">
   <a class="badge badge-light" href="index.html"> forumfutbol Başlık 3</a> 
  ...
  <li class="list-group-item d-flex justify-content-between align-items-center">
      <a class="badge badge-light" href="index.html"> forumfutbolk Başlık 2</a> 
    <span class="badge badge-dark badge-tab">2</span>
  </li>
  <li class="list-group-item d-flex justify-content-between align-items-center">
   <a class="badge badge-light" href="index.html"> forumfutbol Başlık 3</a> 
...
(function() {
 ...
 <a href="baslik acma.php"> <button type="button" class="btn btn-secondary" onclick='index.php'>Yeni Konu Oluştur ++</button></a>
