    ...
    if ( empty(test_input($_POST["icerik"])) ){
       ...
       $sql = "UPDATE entry SET icerik='".$icerik."' WHERE entry_id =".$entry_id ;
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                header('Location: http://theamazingpets.com/baslik1.php?baslik='.$baslik_id.'&sayfa=1');
           ...
           header('Location: http://theamazingpets.com/');
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <?php include 'basliklar.php';?>
    ...
    <div class="sagdiv">
        ...
        <h1><?php echo $baslik_adi; ?> Konusundaki Entry'i Düzenle</h1> <br>
