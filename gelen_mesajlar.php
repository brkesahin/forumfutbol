...
$sorgu = $db->prepare("SELECT  * FROM mesajlar WHERE mesaj_alan=?");
    ...
    <div class="col-md-12 col-lg-6">
        <div class="panel">
    		...
    		<div class="panel-heading">
    			...
    			<h3 class="panel-title">Gelen Kutusu</h3>
    		</div>
							...
							if($xx){
											foreach($x as $v){
												if($v['alan_seen']==1){
													...
													echo '<li class="mar-btm"><div class="media-left">
    								<img src="img\avatar.png" class="img-circle img-sm" alt="Profile Picture">
    							</div>
    									<div class="media-body pad-hor">
    								<div class="speech"><p>';
													
												echo "<b>" . $v["mesaj_gonderen"]."</b>: ".$v["message"]."<br>" .$v["mesaj_tarih"];   
												echo  ' ' . '<a href="gelen_mesaj_sil.php?mesaj_id='.$v["mesaj_id"].'">(Sil)</a>';
												 echo '</p></div>
    							</div>
    						</li>';
												}
