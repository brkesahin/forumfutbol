...
<body>
  ...
  <a class="navbar-brand" href="index.php">
    <img src="img\top.png" width="30" height="30" class="d-inline-block align-top" alt="">
     ForumFutbol
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="nav-item"><a class="nav-link" href="mesaj_yolla.php"><img src="img\giris.png" width="25" height="25" class="d-inline-block align-top" alt="">Mesaj Gönderme/Gelen Kutusu</a></li>
          &emsp;
      <li class="nav-item"><a class="nav-link" href="misafir.php"> <img src="img\kayit.png" width="25" height="25" class="d-inline-block align-top" alt=""> Çıkış Yap </a></li>
...
<div class="container emp-profile">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item" href="mesaj.php"  target="_blank"></a>
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p> <?php if(isset($_SESSION['ad']) && isset($_SESSION['soyad'])) echo $_SESSION['ad']." ".$_SESSION['soyad']; ?> </p>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                 ...
                                 <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p> <?php if(isset($_SESSION['e_mail'])) echo $_SESSION['e_mail'] ;?>  </p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
...
?>
 ...
 <a href="baslik_acma.php"> <button type="button" class="btn btn-secondary" onclick='index.php'>Yeni Konu Oluştur ++</button></a>
              <a href="entry_girme.php"> <button type="button" class="btn btn-secondary">Entry Gir +</button></a>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Evet</button>
            ...
            <div class="modal fade" id="hesapsil" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
